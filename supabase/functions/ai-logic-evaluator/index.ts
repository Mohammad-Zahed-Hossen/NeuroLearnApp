...
if (!GEMINI_API_KEY) {
  console.error('Missing GEMINI_API_KEY environment variable in ai-logic-evaluator function. Set GEMINI_API_KEY in your Supabase function secrets or environment.');
}
