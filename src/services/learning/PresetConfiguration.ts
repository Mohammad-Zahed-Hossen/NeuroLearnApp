 ...
 */
export const COGNITIVE_PRESETS: Record<Exclude<SoundscapeType, 'auto'>, SoundscapePreset> = {
  // No soundscape
  none: {
    id: 'none',
    label: 'Off',
 ...
 */
export function getPreset(presetId: Exclude<SoundscapeType, 'auto'>): SoundscapePreset {
