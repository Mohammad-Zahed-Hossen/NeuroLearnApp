...
const AdaptiveSwitch: React.FC<{ value: boolean; onValueChange: (value: boolean) => void; label: string }> = ({ value, onValueChange, label }) => {
  return (
    <TouchableOpacity
...
export const ContextInsightsPanel: React.FC<ContextInsightsPanelProps> = ({
  ...
  const handleSettingChange = (key: keyof typeof adaptiveSettings, value: boolean) => {
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.serviceGrid}>
              <ServiceStatusPill status={serviceStatuses.cae as any} label="CAE" />
              <ServiceStatusPill status={serviceStatuses.physics as any} label="Physics" />
              <ServiceStatusPill status={serviceStatuses.sensor as any} label="Sensor" />
              <ServiceStatusPill status={serviceStatuses.soundscape as any} label="Soundscape" />
            </View>
          </View>

          {/* 2. Environmental Context */}
          <View style={styles.section}>
            <Text style={[styles.sectionTitle, { color: contextColor }]}>Environmental Context</Text>
            <View style={styles.contextGrid}>
              <View style={styles.contextItem}>
                <Icon name="office-building" size={20} color={themeColors.textSecondary} />
                <Text style={[styles.contextLabel, { color: themeColors.textSecondary }]}>Location</Text>
                <Text style={[styles.contextValue, { color: themeColors.text }]}>
                  {contextSnapshot.locationContext.environment}
                </Text>
              </View>
              <View style={styles.contextItem}>
                <Icon name="volume-high" size={20} color={themeColors.textSecondary} />
                <Text style={[styles.contextLabel, { color: themeColors.textSecondary }]}>Noise</Text>
                <Text style={[styles.contextValue, { color: themeColors.text }]}>
                  {contextSnapshot.locationContext.noiseLevel}
                </Text>
              </View>
              <View style={styles.contextItem}>
                <Icon name="account-group" size={20} color={themeColors.textSecondary} />
                <Text style={[styles.contextLabel, { color: themeColors.textSecondary }]}>Social</Text>
                <Text style={[styles.contextValue, { color: themeColors.text }]}>
                  {contextSnapshot.locationContext.socialSetting}
                </Text>
              </View>
              <View style={styles.contextItem}>
                <Icon name="battery" size={20} color={themeColors.textSecondary} />
                <Text style={[styles.contextLabel, { color: themeColors.textSecondary }]}>Battery</Text>
                <Text style={[styles.contextValue, { color: themeColors.text }]}>
          ...
          {/* 3. Cognitive State */}
          <View style={styles.section}>
            <Text style={[styles.sectionTitle, { color: contextColor }]}>Cognitive State</Text>
            <View style={styles.stateCard}>
              <View style={styles.stateHeader}>
                <Text style={[styles.stateContext, { color: contextColor, backgroundColor: contextColor + '20' }]}>
                  {auraState.context}
                </Text>
              ...
              <Text style={[styles.stateTask, { color: themeColors.textSecondary }]}>
                {auraState.microTask}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.section}>
            <Text style={[styles.sectionTitle, { color: contextColor }]}>Learning Prescription</Text>
            <View style={styles.prescriptionCard}>
              <Text style={[styles.prescriptionPrimary, { color: themeColors.text }]}>
                {auraState.learningPrescription.primary}
              </Text>
              {auraState.learningPrescription.secondary && (
                <Text style={[styles.prescriptionSecondary, { color: themeColors.textSecondary }]}>
                  + {auraState.learningPrescription.secondary}
                </Text>
              )}
              <View style={styles.prescriptionMeta}>
                <Text style={[styles.prescriptionMetaText, { color: themeColors.textSecondary }]}>
                  Duration: {auraState.learningPrescription.duration}min • Intensity: {auraState.learningPrescription.intensity}
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.section}>
            <Text style={[styles.sectionTitle, { color: contextColor }]}>System Integration</Text>
            <View style={styles.integrationGrid}>
              <View style={styles.integrationItem}>
                <Icon name="music-note" size={20} color={themeColors.textSecondary} />
                <Text style={[styles.integrationLabel, { color: themeColors.textSecondary }]}>Soundscape</Text>
                <Text style={[styles.integrationValue, { color: themeColors.text }]}>
                  {auraState.recommendedSoundscape}
                </Text>
              </View>
              <View style={styles.integrationItem}>
                <Icon name="atom" size={20} color={themeColors.textSecondary} />
                <Text style={[styles.integrationLabel, { color: themeColors.textSecondary }]}>Physics</Text>
                <Text style={[styles.integrationValue, { color: themeColors.text }]}>
              ...
              <View style={styles.integrationItem}>
                ...
                <Text style={[styles.integrationLabel, { color: themeColors.textSecondary }]}>Memory</Text>
                <Text style={[styles.integrationValue, { color: themeColors.text }]}>
              ...
              <View style={styles.integrationItem}>
                ...
                <Text style={[styles.integrationLabel, { color: themeColors.textSecondary }]}>Graph</Text>
                <Text style={[styles.integrationValue, { color: themeColors.text }]}>
          ...
          <View style={styles.section}>
            <Text style={[styles.sectionTitle, { color: contextColor }]}>Predictive Insights</Text>
            <View style={styles.predictionsList}>
              {auraState.anticipatedStateChanges.map((change, index) => (
                <View key={index} style={styles.predictionItem}>
                  <Icon name="trending-up" size={16} color={themeColors.textSecondary} />
                  <Text style={[styles.predictionText, { color: themeColors.text }]}>
                    {change.context} in {change.timeframe}min ({(change.probability * 100).toFixed(0)}%)
                  </Text>
                </View>
              ))}
            </View>
          ...
          <View style={styles.section}>
            <Text style={[styles.sectionTitle, { color: contextColor }]}>Performance Metrics</Text>
            <View style={styles.metricsGrid}>
              <View style={styles.metricItem}>
                <Text style={[styles.metricValue, { color: themeColors.text }]}>
                  {(auraState.confidence * 100).toFixed(1)}%
                </Text>
                <Text style={[styles.metricLabel, { color: themeColors.textSecondary }]}>Confidence</Text>
              </View>
              <View style={styles.metricItem}>
                <Text style={[styles.metricValue, { color: themeColors.text }]}>
                  {(auraState.accuracyScore * 100).toFixed(1)}%
                </Text>
                <Text style={[styles.metricLabel, { color: themeColors.textSecondary }]}>Accuracy</Text>
              </View>
              <View style={styles.metricItem}>
                <Text style={[styles.metricValue, { color: themeColors.text }]}>
                  {auraState.adaptationCount}
                </Text>
                <Text style={[styles.metricLabel, { color: themeColors.textSecondary }]}>Adaptations</Text>
              </View>
              <View style={styles.metricItem}>
                <Text style={[styles.metricValue, { color: themeColors.text }]}>
                  {(auraState.contextStability * 100).toFixed(1)}%
                </Text>
                <Text style={[styles.metricLabel, { color: themeColors.textSecondary }]}>Stability</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.settingsList}>
              ...
              <AdaptiveSwitch
                ...
                onValueChange={(value) => handleSettingChange('predictiveAlerts', value)}
                label="Predictive State Alerts"
              />
              <AdaptiveSwitch
                value={adaptiveSettings.environmentalSensing}
                onValueChange={(value) => handleSettingChange('environmentalSensing', value)}
                label="Environmental Sensing"
              />
              <AdaptiveSwitch
                value={adaptiveSettings.learningPrescription}
                onValueChange={(value) => handleSettingChange('learningPrescription', value)}
